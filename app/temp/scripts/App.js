...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        en cuanto cargue la web y asi con los demas*/
    ...
    _createClass(StickyHeader, [{
        ...
        value: function createHeaderWaypoint() {
            var that = this;
            new Waypoint({
                /*Aqui ponemos [0] pq waypoint esta esperando
                un elemento DOM nativo de JS y estamos pasando 
                en su lugar un jquery object, con [0] arreglamos 
                esto debido a que el primer elemento de un array 
                como es object en jquery siempre apunta al DOM
                nativo*/
...
var Modal = function () {
    ...
    _createClass(Modal, [{
        ...
        value: function events() {
            ...
            //push any key to exit modal frame
